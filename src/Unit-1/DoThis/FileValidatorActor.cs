        ...
        protected override void OnReceive(object message)
        {
            ...
            else
            {
                ...
                if (isValid)
                {
                    ...
                    var actorSelection = Context.ActorSelection("akka://MyActorSystem/user/MyTailCoordinatorActor");
                    actorSelection.Tell(new TailCoordinatorActor.StartTail(msg, _consoleWriterActor));
                }
                else
                {
